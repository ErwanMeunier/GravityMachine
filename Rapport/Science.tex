...
Ideally, one would that each generator converge to a the set 
Let be $J_0(x)$ (and $J_1(x)$) the set containing the index of variables set to zero (respectively to one) into the solution $x$. S
